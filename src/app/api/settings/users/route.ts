...
const roles = new Set<MembershipRole>(['OWNER', 'ADMIN', 'RESPONSIBLE_TECH', 'OCCUPATIONAL_PHYSICIAN', 'MEDICAL_ASSISTANT', 'CONSULTANT', 'ASSISTANT', 'REVIEWER', 'COMMERCIAL', 'FINANCE', 'READER']);
